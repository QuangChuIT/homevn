<%@ page import="com.home.app.model.Category" %>
<%@ page import="java.util.List" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%
    Category category = (Category) request.getAttribute("category");
    List<Category> childs = category.getCategories();
%>
<div class="">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left"
                          action="<c:url value="/quan-tri-chuyen-muc/cap-nhat"/>" method="post" novalidate>
                        <input type="hidden" name="cateId" id="cateId" value="<%=category.getId()%>">
                        <span class="section">Thông tin chuyên mục</span>
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 text-center error">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" class="form-control col-md-7 col-xs-12"
                                       ...
                                       placeholder="e.g Tin công nghệ" value="<%=category.getName()%>"
                                       required="required"
                                       type="text">
                            </div>
                        </div>
                            ...
                            <%
                                ...
                                if (childs != null) {
                                    for (Category cate : childs) {
                                        child.append(cate.getName()).append(",");
                                    }
                                }
                            %>
                            <div class="col-md-6 col-sm-6 col-xs-12">
