...
public class GetterUtil {
	...
	public static String[] getStringArray(String value){
		return getStringArray(value, _default_string_token);
	}

	public static String[] getStringArray(String value, String pattern){

		try{
			StringTokenizer stringTokenizer = new StringTokenizer(value, pattern);

			if(stringTokenizer != null){

				int arrSize = stringTokenizer.countTokens();
				...
				while (stringTokenizer.hasMoreTokens()){
					strings[strings.length - 1] = stringTokenizer.nextToken();
				}
			...
			_log.error("Token: " + value + " pattern: " + pattern);
	...
	private static final String _default_string_token = ",";
