...
package com.home.app.service.kernel.unsync;
...
public class UnsyncStringWriter extends Writer {
	...
	public UnsyncStringWriter(boolean useStringBundler) {
		if (useStringBundler) {
			stringBundler = new StringBuffer();
		} else {
	...
	public UnsyncStringWriter(boolean useStringBundler, int initialCapacity) {
		if (useStringBundler) {
			stringBundler = new StringBuffer(initialCapacity);
		} else {
	...
	public UnsyncStringWriter append(CharSequence charSequence, int start,
			int end) {
	...
	public StringBuffer getStringBundler() {
		return stringBundler;
	}

	public void reset() {
		if (stringBundler != null) {
			stringBundler = new StringBuffer(0);
		} else {
	...
	protected StringBuffer stringBundler;
